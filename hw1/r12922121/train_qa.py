...
open context file
'''
with open("/home/guest/r12922121/ADL_2023_NTU/hw1/data/context.json", "r") as f:
...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        context = []
        # print(examples["relevant"])
        for i in range(len(examples["relevant"])):
            context.append(context_file[examples["relevant"][0]])
        # print(context)
...
def main():
    ...
    def prepare_train_features(examples):
        ...
        for i in range(len(examples["question"])):
            context.append(context_file[examples["relevant"][i]])
    ...
    def prepare_validation_features(examples):
        ...
        for i in range(len(examples["question"])):
            if "relevant" in examples:
                ...
                raise ValueError("file doesn't have key relevant or paragraphs")
        # Tokenize our examples with truncation and maybe padding, but keep the overflows using a stride. This results
        # in one example possible giving several features when a context is long, each of those features having a
        # context that overlaps a bit the context of the previous feature.
        tokenized_examples = tokenizer(
    ...
    if args.do_predict:
        ...
        #     data_files["test"] = args.test_file
        # extension = args.train_file.split(".")[-1]
        # test_datasets = load_dataset(extension, data_files=data_files)
        # predict_examples = test_datasets["test"]
